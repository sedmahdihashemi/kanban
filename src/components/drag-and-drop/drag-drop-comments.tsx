...
export function KanbanDynamicOverlayDemo({ selectedTweetComments,columns, setColumns }:{selectedTweetComments:Task[],columns:Record<string, Task[]> , setColumns:any}) {

  const [columns, setColumns] = React.useState<Record<string, Task[]>>({pending:selectedTweetComments , reject : [] , done:[]});
React.useEffect(()=>{
  setColumns({pending:selectedTweetComments})
...
console.log(columns);
  ...
  return (
    ...
    >
      <Kanban.Board className="grid max-h-96 overflow-y-scroll grid-cols-1 ">
